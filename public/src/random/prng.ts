export interface PRNGInterface {
  MathRandom: () => number
  sfc32: (a: number, b: number, c: number, d: number) => Function
  splitMix32: (a: number) => Function
...
export const PRNG: PRNGInterface = {
  ...
  sfc32(a: number = 1, b: number = 1, c: number = 1, d: number = 1): Function {
    return (): number => {
      a >>>= 0
      b >>>= 0
      c >>>= 0
  ...
  splitMix32(a: number = 1): Function {
    return (): number => {
      a |= 0
      a = a + 0x9e3779b9 | 0
      let t = a ^ a >>> 16
